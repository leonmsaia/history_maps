...
class Map_model extends CI_Model
{
  ...
  public function get_all_projects_by_author($author_id)
  {
    $this->db->where('map_project_author', $author_id);
    $this->db->join('users', 'users.id = map_project.map_project_author');
    $result = $this->db->get('map_project');
    return $result;
  }
  ...
  public function get_map_author_by_project_code($map_project_code)
  {
    $this->db->where('map_project_code', $map_project_code);
    $this->db->join('users', 'users.id = map_project.map_project_author');
  ...
  public function get_map_assets_components_by_map_id($map_id)
  {
    $this->db->where('map_assets_components_map_id', $map_id);
    $result = $this->db->get('map_assets_components');
    return $result;
  }
